...
(
    ...
    TALLER INT(5) NOT NULL, /**FK CLAVE TALLER, REL REALIZAR REPARACION, OBLIGATORIA**/
    COCHE INT(5) NOT NULL,  /**FK CLAVE COCHE, REL SER REPARADO, OBLIGATORIA**/
